...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-account_analytic_document_date>=16.0dev,<16.1dev',
        ...
        'odoo-addon-account_analytic_sequence>=16.0dev,<16.1dev',
        ...
        'odoo-addon-product_analytic_sale>=16.0dev,<16.1dev',
