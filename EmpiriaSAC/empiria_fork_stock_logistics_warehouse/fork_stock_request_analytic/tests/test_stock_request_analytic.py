...
class TestForkStockRequestAnalytic(test_stock_request.TestForkStockRequest):
    def setUp(self):
        super(TestForkStockRequestAnalytic, self).setUp()
        ...
        self.demand_route = self.env["stock.route"].create(
            {
                "name": "Transfer",
