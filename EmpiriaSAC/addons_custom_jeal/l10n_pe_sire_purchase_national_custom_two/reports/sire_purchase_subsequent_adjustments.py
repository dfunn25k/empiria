...
class SirePurchaseSubsequentAdjustmentsXlsx:
    ...
    def _write_headers_report(workbook, worksheet):
        ...
        worksheet.write(0, 42, "Fecha de pago", style_header)
        worksheet.write(0, 43, "Número de voucher", style_header)
    ...
    def _write_rows_report(workbook, worksheet, processed_results):
        ...
        for dict_result in processed_results:
            ...
            worksheet.write(
                row, 42, dict_result["detraction_voucher_payment_date"], style_content
            )
            worksheet.write(
                row, 43, dict_result["detraction_voucher_number"], style_content
            )
...
class SirePurchaseSubsequentAdjustmentsTxt:
    ...
    def _get_template_report():
        return (
            ...
            "{detraction}||||{detraction_voucher_payment_date}|{detraction_voucher_number}|\r\n"
        )
    ...
    def _write_template_report(template, processed_results):
        ...
        for dict_result in processed_results:
            ...
            content += template.format(
                ...
                detraction_voucher_payment_date=dict_result[
                    "detraction_voucher_payment_date"
                ],
                detraction_voucher_number=dict_result["detraction_voucher_number"],
            )
        return content
