...
class OperationTypeSunat(models.Model):
    _name = "operation.type.sunat"
    _description = "Operation Type for SUNAT Reporting"
    ...
    move_id = fields.Many2one(
        ...
        required=True,
        readonly=True,
        help="Movimiento de stock relacionado con esta operación.",
    )
    ...
    product_id = fields.Many2one(
        ...
        store=True,
        readonly=True,
        help="Producto relacionado con el movimiento de stock.",
    )

    # description_picking = fields.Text(
    #     string="Picking Description",
    #     related="move_id.description_picking",
    #     help="Descripción del picking tomada del campo 'description_picking' en el modelo relacionado 'move_id'.",
    #     readonly=True,
    # )

    sunat_operation_type = fields.Selection(
        selection=stock_picking_reason,
        related="move_id.sunat_operation_type",
        string="Tipo de Operación SUNAT",
        readonly=False,
        help="Tipo de operación para reportes de SUNAT.",
    )
    ...
    picking_id = fields.Many2one(
        ...
        readonly=True,
        check_company=True,
        help="Albarán relacionado con la operación.",
    )
