...
class AttendanceDevice(models.Model):
    ...
    name = fields.Char(
        string="Name", required=True, help='The name of the attendance device', tracking=True, translate=True, copy=True, default='/',
    ...
    fingerprint_algorithm = fields.Char(
        string='Fingerprint Algorithm', readonly=True,
    ...
    device_name = fields.Char(
        string='Device Name', readonly=True,
    ...
    work_code = fields.Char(
        string='Work Code', readonly=True,
        help="The Work Code of the device which will be filled automatically when you hit the 'Get Device Info' button."
    )
    ip = fields.Char(
        string="IP / Domain Name", required=True, tracking=True, copy=False, readonly=True, states={'draft': [('readonly', False)]},
    ...
    timeout = fields.Integer(
        string='Timeout', default=20, required=True, help='Connection Timeout in second', tracking=True,
        readonly=True, states={'draft': [('readonly', False)]}
    )
    ...
    device_user_ids = fields.One2many(
        comodel_name='attendance.device.user',
    ...
    mapped_employee_ids = fields.Many2many(
        comodel_name='hr.employee',
        relation='mapped_device_employee_rel',
        string='Mapped Employees',
    ...
    umapped_device_user_ids = fields.One2many('attendance.device.user', 'device_id', string='Unmapped Device Users',
    ...
    auto_clear_attendance_hour = fields.Float(
        string='Auto Clear At', tracking=True, required=True, default=0.0,
        help="The time (in the attendance device's timezone) to clear attendance data after download."
    )
    cached_key = fields.Char(string='Cached key ID')
    ...
    def connect(self):
        ...
        try:
            self._set_zk()
            return self.zk_cache[self.cached_key].connect()
    ...
    def disconnect(self):
        try:
            return self.zk_cache[self.cached_key].disconnect()
        except Exception as e:
            _logger.error(e)
    ...
    def disableDevice(self):
        ...
        """
        try:
            return self.zk_cache[self.cached_key].disable_device()
        except Exception as e:
            _logger.error(e)
    ...
    def enableDevice(self):
        ...
        """
        try:
            return self.zk_cache[self.cached_key].enable_device()
        except Exception as e:
            _logger.error(e)
    ...
    def getFirmwareVersion(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk_cache[self.cached_key].get_firmware_version()
        except Exception as e:
            _logger.error(e)
    ...
    def getSerialNumber(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk_cache[self.cached_key].get_serialnumber()
        except Exception as e:
            _logger.error(e)
    ...
    def getOEMVendor(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk_cache[self.cached_key].get_oem_vendor()
        except Exception as e:
            _logger.error(e)
    ...
    def getFingerprintAlgorithm(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk_cache[self.cached_key].get_fp_version()
        except Exception as e:
            _logger.error(e)
    ...
    def getPlatform(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk_cache[self.cached_key].get_platform()
        except Exception as e:
            _logger.error(e)
    ...
    def getDeviceName(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk_cache[self.cached_key].get_device_name()
        except Exception as e:
            _logger.error(e)
    ...
    def getWorkCode(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk_cache[self.cached_key].get_workcode()
        except Exception as e:
            _logger.error(e)
    ...
    def restartDevice(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk_cache[self.cached_key].restart()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(_('Could not get the serial number of the device %s. Here is the debugging information:\n%s')
                                  % (self.display_name, e))
    ...
    def setUser(self, uid=None, name='', privilege=0, password='', group_id='', user_id='', card=0):
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].set_user(uid, name, privilege, password, group_id, user_id, card)
        except Exception as e:
            _logger.info(e)
    ...
    def delUser(self, uid, user_id):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].delete_user(uid, user_id)
        except Exception as e:
            _logger.error(e)
    ...
    def action_clear_data(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].clear_data()
        except Exception as e:
            _logger.error(e)
    ...
    def getUser(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].get_users()
        except Exception as e:
            _logger.error(str(e))
    ...
    def upload_finger_templates(self, uid, name, privilege, password, group_id, user_id, fingers):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].save_user_template(user, fingers)
        except Exception as e:
            _logger.error(e)
    ...
    def delFingerTemplate(self, uid, fid, user_id):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].delete_user_template(uid, fid, user_id)
        except Exception as e:
            _logger.error(e)
    ...
    def getFingerTemplate(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].get_templates()
        except Exception as e:
            _logger.error(str(e))
    ...
    def get_next_uid(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].get_next_uid()
        except Exception as e:
            _logger.error(str(e))
    ...
    def getMachineTime(self):
        try:
            self.connect()
            self.enableDevice()
            return self.zk_cache[self.cached_key].get_time()
        except Exception as e:
            _logger.error(str(e))
    ...
    def getAttendance(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].get_attendance()
    ...
    def clearAttendance(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk_cache[self.cached_key].clear_attendance()
        except Exception:
            raise ValidationError(_('Could not get attendance data from the device %s') % (self.display_name,))
        finally:
            self.enableDevice()
