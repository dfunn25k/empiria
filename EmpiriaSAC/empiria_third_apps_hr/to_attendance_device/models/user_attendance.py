...
class UserAttendance(models.Model):
    ...
    status = fields.Integer(
        string='Device Attendance State', required=True,
    ...
    attendance_state_id = fields.Many2one(
        comodel_name='attendance.state',
        string='Odoo Attendance State',
    ...
    valid = fields.Boolean(
        string='Valid Attendance', index=True, readonly=True, default=False,
