...
class AccountMove(models.Model):
    ...
    types_goods_services_id = fields.Many2one(
        ...
        default=lambda self:self._default_classification_service()
    )
    
    @api.model
    def _default_classification_service(self):
        return self.env['classification.services'].search([], limit=1)
