...
class AccountTax(models.Model):
    ...
    def automated_links(self):
        ...
        new_account = self.env['account.account'].search([('code', '=', '4011500')], limit=1)

        if new_account.company_id != account_tax.company_id:
            pass
        else:
            if account_tax.company_id.country_id.code != 'PE':
                account_tax.company_id = company_id
        ...
        new_account_1 = self.env['account.account'].search([('code', '=', '1674000')], limit=1)
        new_account_2 = self.env['account.account'].search([('code', '=', '4011200')], limit=1)
        
        if new_account_1.company_id != account_tax.company_id or new_account_2.company_id != account_tax.company_id:
            pass
        else:
            if account_tax.company_id.country_id.code != 'PE':
                account_tax.company_id = company_id
        ...
        new_account = self.env['account.account'].search([('code', '=', '4011300')], limit=1)
        ...
        new_account_1 = self.env['account.account'].search([('code', '=', '6419000')], limit=1)
        new_account_2 = self.env['account.account'].search([('code', '=', '4017400')], limit=1)
