...
class SaleReportExcel(object):
    ...
    def get_content(self):
        ...
        worksheet.write(
            0,
            3,
            "Número correlativo del \nasiento contable identificado en el campo 2",
            style1,
        )
        ...
        worksheet.write(
            0, 28, "F. emisión documento original \nque se modifica", style1
        )
