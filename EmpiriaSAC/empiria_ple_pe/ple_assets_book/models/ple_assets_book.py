...
class PleAssetsBook(models.Model):
    ...
    def _get_lines_1(self):
        ...
        COALESCE(SUBSTRING(aa.asset_brand from 1 for 20),'-') as asset_brand,
        COALESCE(SUBSTRING(aa.asset_model from 1 for 20),'-') as asset_model,
        COALESCE(SUBSTRING(aa.asset_series from 1 for 30),'-') as asset_series,
