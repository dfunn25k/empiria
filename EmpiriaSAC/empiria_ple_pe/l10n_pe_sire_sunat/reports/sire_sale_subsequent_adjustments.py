...
class SireSaleSubsequentAdjustmentsXlsx:
    def __init__(self, obj, processed_results):
        self.obj = obj
        self.processed_results = processed_results

    def __str__(self):
        return "Reporte RVIE - Cuando realiza ajustes posteriores XLSX - {}, {}{}".format(
    ...
    def _write_headers_report(workbook, worksheet):
        ...
        worksheet.write(0, 14, 'Valor Facturado Exportación', style_header)
        ...
        worksheet.write(0, 35, 'CLU', style_header)
    ...
    def _write_rows_report(workbook, worksheet, processed_results):
        ...
        for dict_result in processed_results:
            car_sunat_modifying = "{}{}{}{}".format(
                dict_result['partner_vat'],
                dict_result['document_type_code'],
                dict_result['invoice_serie'],
                dict_result['invoice_correlative']
            ).strip()
            ...
            worksheet.write(row, 34, car_sunat_modifying)
            worksheet.write(row, 35, dict_result['detraction'], style_content)
            row += 1
...
class SireSaleSubsequentAdjustmentsTxt:
    def __init__(self, obj, processed_results):
        self.obj = obj
        self.processed_results = processed_results

    def __str__(self):
        return "Reporte RVIE - Cuando realiza ajustes posteriores TXT - {}, {}{}".format(
            self.obj.company_id.name,
            self.obj.year,
            self.obj.month
        )
    ...
    def _get_template_report():
        return '{company_vat}|{company_name}|' \
            ...
            '{car_sunat_modifying}|{detraction}|\r\n'
    ...
    def _write_template_report(template, processed_results):
        ...
        for dict_result in processed_results:
            ...
            content += template.format(
                ...
                car_sunat_modifying=car_sunat_modifying,
